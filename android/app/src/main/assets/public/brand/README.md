...
- Le **splash** (Web + assets) utilise **`#2C5DD9`** (`RUCONNECT_SPLASH_BLUE` dans `src/lib/ruconnectSplashChrome.ts`). Aligner `index.html` + `theme-color` initial avec ce bleu si besoin.
