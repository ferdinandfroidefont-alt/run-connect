-- Update the get_friend_suggestions function to respect the allow_friend_suggestions setting
...
AS $$
  ...
  WHERE p.is_private = false  -- Only suggest public profiles
    AND p.allow_friend_suggestions = true  -- Only suggest users who allow friend suggestions
    AND EXISTS (
