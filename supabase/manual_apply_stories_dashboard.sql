-- ============================================================================
-- Option 1 — À exécuter dans Supabase : Dashboard → SQL Editor → New query
-- Corrige « Bucket not found » + assure table story_media et RLS.
-- Idempotent : tu peux relancer le script sans tout casser (sauf erreurs déjà corrigées).
-- ============================================================================

-- --- session_stories (colonnes utilisées par les stories récentes) ---
...
-- --- bucket Storage (public : URLs publiques pour affichage) ---
...
-- --- politiques Storage sur le bucket story-media ---
