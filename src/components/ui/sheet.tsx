...
const sheetVariants = cva(
  "fixed z-50 gap-4 backdrop-blur-xl bg-background/95 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.4)] transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
