...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap btn-premium text-base font-semibold ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 md:text-sm shadow-lg hover:shadow-xl",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-to-r from-[#385bdc] via-[#10c8d5] to-[#10c8d5] text-white shadow-lg hover:shadow-glow hover:scale-105 active:scale-95",
        destructive:
