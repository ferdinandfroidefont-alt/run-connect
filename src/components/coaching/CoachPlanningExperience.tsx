...
import { CoachingWizardStep4Builder } from "@/components/coaching/create-session/CoachingWizardStep4Builder";
          ...
          >
            <div className="px-5 pb-6 pt-5" style={{ background: COACHING_PAGE_BG }}>
              ...
              {showCreateSessionEditor ? (
                <CoachingWizardStep4Builder
                  wizardSportId={draft.wizardSportId ?? "course"}
                  locationLine={draft.defaultLocationName ?? ""}
                  editorTab={editorTab}
                  onEditorTabChange={setEditorTab}
                  hideTabs={createSessionSurface === "weekEditor"}
