          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {activityTypes.map(activity => <Button key={activity.id} onClick={() => toggleActivityType(activity.id)} variant={filters.activity_types.includes(activity.id) ? "default" : "outline"} size="sm" className="justify-start text-xs h-8">
