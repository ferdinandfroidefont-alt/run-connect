                ...
                <div className="space-y-1">
                  ...
                  <div className="bg-card overflow-hidden">
                    ...
                    <div className="flex items-center gap-3 px-4 py-3">
                      <div className={`h-[30px] w-[30px] rounded-[7px] flex items-center justify-center ${isMuted || !notificationsEnabled ? 'bg-muted' : 'bg-destructive'}`}>
                        {isMuted || !notificationsEnabled 
                          ? <BellOff className="h-[18px] w-[18px] text-muted-foreground" />
                          : <Bell className="h-[18px] w-[18px] text-destructive-foreground" />
                        }
                      </div>
